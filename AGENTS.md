...
Next: the last closed-loop v1 item (native mean-field space charge)
with engine-track M1' build recipes in parallel; then the GPU lane and
the interactive viewer. See docs/roadmap.md.
